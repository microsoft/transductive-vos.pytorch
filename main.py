...
yt_train_imgs = 'train/JPEGImages'
yt_train_labels = 'train/Annotations'
yt_val_imgs = 'valid/JPEGImages'
yt_val_labels = 'valid/Annotations'
...
def main(args):
    ...
    train_dataset = dataset.YouTubeTrain(os.path.join(args.data, yt_train_imgs),
                                       os.path.join(args.data, yt_train_labels),
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               pin_memory = True,
                                               num_workers=32 // dist.get_world_size(),
                                               drop_last=True)
    val_dataset = dataset.YouTubeTrain(os.path.join(args.data, yt_val_imgs),
                                     os.path.join(args.data, yt_val_labels),
                                     cropping=args.crop_size,
                                     frame_num=args.frame_num,
                                     color_jitter=args.cj)
